//------------------------------------------------------------------------------
///@file lib_file_info.cpp                                                      
///                                                                             
///@par Classification: unclassified, OPEN SOURCE                                            
///                                                                             
///@brief Contains the implementation code for the lib::file::Info class        
...
std::string Info::localizePath(std::string path)
{
    char pathSeparator = *lib::file::Info::pathSeparator().c_str();
...
std::string Info::localizePath() const
{
    return localizePath(m_Path);
}
