...
class Message
{
    public:
        ...
        using PARTS = lib::ds::Flags<PART_ENUM>;
...
using MessagePtr = lib::ds::shared_ptr<Message>;
using ConstMessagePtr = lib::ds::shared_ptr<const Message>;
