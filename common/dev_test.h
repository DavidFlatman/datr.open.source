...
///@file dev_test.h                                                             
///                                                                             
///@brief Holds the declaration of the dev::Test class; the basis for           
///       @e useful testing.                                                    
///                                                                             
...
#ifndef DEV_TEST_H_FILE_GUARD
#define DEV_TEST_H_FILE_GUARD
...
///         dev::Test in order to test the Directory class.                     
///                                                                             
///@par Expected Usage:                                                         
///         @code                                                               
///             namespace lib {                                                 
...
class Test {
    ...
    private:
        ...
        ATOMIC_INT32_T  m_Failed;
        ATOMIC_INT32_T  m_Passed;
        ATOMIC_INT32_T  m_NotImplemented;
...
#define TEST(cond)                                                          \
    try {                                                                   \
        conditionalTest(cond, #cond, __FILE__, __LINE__);                   \
...
#define TEST_NOT_IMPLEMENTED                                                \
        notImplemented(__func__, __FILE__, __LINE__);
...
#define TEST_PREFIX(prefix, cond)                                               \
    try {                                                                       \
        conditionalTest(cond,((std::string)prefix) + #cond, __FILE__, __LINE__);\
    } catch(const std::exception& e) {                                          \
        FAIL(                                                                   \
        ...
        FAIL("exception thrown: " + std::string(prefix) + #cond);               \
    }
...
#define TEST_ABORT_IF_FAIL(cond)                                            \
    try {                                                                   \
        if (!conditionalTest(cond, #cond, __FILE__, __LINE__)) return;      \
    } catch(const std::exception& e) {                                      \
        std::string msg("std::exception thrown: ");                         \
        msg += e.what();                                                    \
        msg += "  " #cond;                                                  \
...
#define TEST_ABORT_WITH_RESULT(cond, result)                                 \
    try {                                                                    \
        if (!conditionalTest(cond, #cond, __FILE__, __LINE__)) return result;\
    } catch(const std::exception& e) {                                       \
        std::string msg("std::exception thrown: ");                          \
        msg += e.what();                                                     \
        msg += "  " #cond;                                                   \
...
#define TEST_CONSTRUCTOR(constructor)                                       \
    try {                                                                   \
        constructor;                                                        \
        conditionalTest(true, #constructor, __FILE__, __LINE__);            \
    } catch(const std::exception& e) {                                      \
        std::string msg("std::exception thrown: ");                         \
        msg += e.what();                                                    \
        msg += "  " #constructor;                                           \
...
//------------------------------------------------------------------------------
#define FAIL(str)  conditionalTest(false, str,  __FILE__, __LINE__)
...
//------------------------------------------------------------------------------
#define PASS(str)  conditionalTest(true,  str,  __FILE__, __LINE__)
...
#endif // #ifndef DEV_TEST_H_FILE_GUARD //
